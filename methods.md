...
In version 4, data from four cruises were added and the data table was reordered to have blanks at the end.

# Related Packages

Particulate organic carbon and nitrogen somtetimes sampled at the same depth on NES-LTER transect crusies are in the following package:

Sosik, H.M., E.T. Crockford, and E. Peacock. 2025. Particulate organic carbon (POC) and nitrogen (PON) from Northeast U.S. Shelf Long Term Ecological Research (NES-LTER) Transect cruises, ongoing since 2017 ver 3. Environmental Data Initiative. https://doi.org/10.6073/pasta/79463e428673133dd9f7994e54e7daf6 (Accessed 2026-06-04).

Discrete dissolved inorganic nutrient data, which could be used together with these data to calculate dissolved organic nitrogen (DON) and the DOC to DON ratio, are in the following package:
